...
def main():
    ...
    for fseed in range(3):
        ...
        for epoch in range(1, num_epochs + 1):
            ...
            top1_acc_val = validate(model, loader_val, autocast=autocast)
            ...
            if val_acc > best_val_acc:
                ...
                util.save(args.log_dir, model, str='best_'+str(args.shot)+'_'+str(fseed))
            if epoch == num_epochs:
                util.save(args.log_dir, model, str='final_'+str(args.shot)+'_'+str(fseed))
