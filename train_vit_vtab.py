...
def main():
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        top1_acc_eval = train_one_epoch(epoch, model, loader_train, loader_eval, optimizer, criterion, args,
...
def train_one_epoch(epoch, model, loader, loader_eval, optimizer, loss_fn, args, autocast, model_ema=None,
